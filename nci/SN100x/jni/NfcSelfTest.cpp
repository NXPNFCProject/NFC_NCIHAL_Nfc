...
tNFA_STATUS NfcSelfTest::PerformSPCTest() {
  ...
  uint8_t SPCTestCmdSeq_SN220[] = {CMD_TYPE_CORE_RESET, CMD_TYPE_CORE_INIT,
          ...
          CMD_TYPE_SPC_BLK1_SN220, CMD_TYPE_SPC_BLK2_SN220, CMD_TYPE_SPC_BLK3_SN220, CMD_TYPE_SPC_START};
