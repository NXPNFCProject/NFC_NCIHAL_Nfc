...
/*
 *  Util class to handle Nfc statsd logging
 */
class NfcStatsUtil {
 public:
  virtual ~NfcStatsUtil() = default;
  ...
  **
  *******************************************************************************/
  void logNfcTagType(int protocol, int discoveryMode);
  ...
  **
  *******************************************************************************/
  virtual void writeNfcStatsTagTypeOccurred(int tagType);
};
